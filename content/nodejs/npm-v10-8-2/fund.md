...
NAME
   ...
   Description
       This command retrieves information on how to fund the dependencies of a given project. If no package name is provided, it will list all dependencies that are looking for funding in a tree structure, list‐
       ing  the type of funding and the url to visit. If a package name is provided then it tries to open its funding url using the --browser config ⟨/using-npm/config#browser⟩ param; if there are multiple fund‐
       ing sources for the package, the user will be instructed to pass the --which option to disambiguate.
...
NPM@10.8.2                                                                                           July 2024                                                                                          NPM-FUND(1)
