...
NAME
   ...
   Description
       ...
       •   ls-collaborators (deprecated): Show all of the access privileges for a package. Will only show permissions for packages to which you have at least read access. If <user> is passed in, the list is fil‐
           tered only to teams that user happens to belong to.
...
NPM@10.8.2                                                                                           July 2024                                                                                        NPM-ACCESS(1)
