...
NAME
   ...
   Description
       ...
       During  the  installation  process,  the  c@1.0.3 dependency for b was placed in the root of the tree. Though d's dependency on c@1.x could have been satisfied by c@1.0.3, the newer c@1.9.0 dependency was
       used, because npm favors updates by default, even when doing so causes duplication.
...
NPM@10.8.2                                                                                           July 2024                                                                                        NPM-DEDUPE(1)
